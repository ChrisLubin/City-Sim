...
public class IntersecionRightOfWayController : MonoBehaviour
{
    ...
    {
        public IAiMovementController MovementController { get; private set; }
        public Direction DirectionComingIn { get; private set; }
        public Direction DirectionComingOut { get; private set; }

        public AiVehicleInIntersectionData(IAiMovementController movementController, Direction directionComingIn, Direction directionComingOut)
        {
    ...
    private void Update()
    {
        IAiMovementController vehicleEnteringInNorthboundLane = this.GetAiVehicleMovementControllerInDirection(Direction.North, true);
        IAiMovementController vehicleEnteringInEastboundLane = this.GetAiVehicleMovementControllerInDirection(Direction.East, true);
        IAiMovementController vehicleEnteringInSouthboundLane = this.GetAiVehicleMovementControllerInDirection(Direction.South, true);
        IAiMovementController vehicleEnteringInWestboundLane = this.GetAiVehicleMovementControllerInDirection(Direction.West, true);

        IAiMovementController vehicleExitingInNorthboundLane = this.GetAiVehicleMovementControllerInDirection(Direction.North, false);
        IAiMovementController vehicleExitingInEastboundLane = this.GetAiVehicleMovementControllerInDirection(Direction.East, false);
        IAiMovementController vehicleExitingInSouthboundLane = this.GetAiVehicleMovementControllerInDirection(Direction.South, false);
        IAiMovementController vehicleExitingInWestboundLane = this.GetAiVehicleMovementControllerInDirection(Direction.West, false);
    ...
    private void OnVehicleInEnterCheckpointUpdate(bool isNorthSouthTraffic, IAiMovementController movementController)
    {
    ...
    private void HandleGreenLightTrafficUpdate(bool isNorthSouthTraffic, IAiMovementController firstDirectionVehicle, IAiMovementController secondDirectionVehicle, Direction firstVehicleDirection)
    {
        ...
        IAiMovementController vehicleToProcessFirst = null;
        IAiMovementController vehicleToProcessSecond = null;
    ...
    private void OnDetectedVehicleEnteringOnGreenLight(IAiMovementController movementController, Direction directionComingIn)
    {
    ...
    private void OnVehicleExitingIntersectionUpdate(IAiMovementController movementController)
    {
        if (movementController == null) { return; }
    ...
    private void OnCarHavingRightOfWay(IAiMovementController movementController, Direction directionComingIn)
    {
    ...
    private IAiMovementController GetAiVehicleMovementControllerInDirection(Direction direction, bool isEntering)
    {
