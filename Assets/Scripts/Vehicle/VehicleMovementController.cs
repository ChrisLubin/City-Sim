...
public class VehicleMovementController : NetworkBehaviour
{
    ...
    [Range(10, 120)]
    public int maxReverseSpeed = 40; //The maximum speed that the car can reach while going on reverse in km/h.
    [Range(1, 10)]
    ...
    [Space(10)]
    [Range(100, 600)]
    public int brakeForce = 406; // The strength of the wheel brakes.
    [Range(1, 10)]
    public int decelerationMultiplier = 2; // How fast the car decelerates when the user is not using the throttle.
    [Range(1, 10)]
    public int handbrakeDriftMultiplier = 7; // How much grip the car loses when the user hit the handbrake.
    [Space(10)]
